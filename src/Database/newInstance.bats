...
function Database::newInstance::defaultOptions { #@test
  ...
  [[ "${dbFromInstance['DUMP_OPTIONS']}" = "--default-character-set=utf8  --compression-algorithms=zstd --hex-blob --routines --triggers --single-transaction --set-gtid-purged=OFF --column-statistics=0 --ssl-mode=DISABLED" ]]
