...
fixMarkdownToc "${DOC_DIR}/FrameworkFullDoc.md"
fixMarkdownToc "${DOC_DIR}/BestPractices.md"
fixMarkdownToc "${DOC_DIR}/CompileCommand.md"
fixMarkdownToc "${DOC_DIR}/README.md"
fixMarkdownToc "${DOC_DIR}/Commands.md"
