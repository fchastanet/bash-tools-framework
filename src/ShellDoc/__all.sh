...
source "${FRAMEWORK_DIR}/src/ShellDoc/generateShellDoc.sh"
# shellcheck source=src/ShellDoc/generateShellDocFile.sh
source "${FRAMEWORK_DIR}/src/ShellDoc/generateShellDocFile.sh"
# shellcheck source=src/ShellDoc/generateShellDocsFromDir.sh
source "${FRAMEWORK_DIR}/src/ShellDoc/generateShellDocsFromDir.sh"
# shellcheck source=src/ShellDoc/installRequirementsIfNeeded.sh
source "${FRAMEWORK_DIR}/src/ShellDoc/installRequirementsIfNeeded.sh"
# shellcheck source=src/Git/shallowClone.sh
source "${FRAMEWORK_DIR}/src/Git/shallowClone.sh"
