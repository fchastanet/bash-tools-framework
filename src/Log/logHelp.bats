...
function Log::logHelp::debugLevel { #@test
  stub date \
    '* : echo "dateMocked"' \
    '* : echo "dateMocked"'
  ...
  assert_line --index 1 "dateMocked|   HELP|help"
}

function Log::logHelp::infoLevel { #@test
  stub date \
    '* : echo "dateMocked"' \
    '* : echo "dateMocked"'
...
function Log::logHelp::successLevel { #@test
  stub date \
    '* : echo "dateMocked"' \
    '* : echo "dateMocked"'
...
function Log::logHelp::warningLevel { #@test
  stub date \
    '* : echo "dateMocked"'
...
function Log::logHelp::errorLevel { #@test
  stub date \
    '* : echo "dateMocked"'
...
function Log::logHelp::offLevel { #@test
