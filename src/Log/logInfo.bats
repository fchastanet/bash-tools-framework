...
function Log::logInfo::debugLevel { #@test
  stub date \
    '* : echo "dateMocked"' \
    '* : echo "dateMocked"'
...
function Log::logInfo::infoLevel { #@test
  stub date \
    '* : echo "dateMocked"' \
    '* : echo "dateMocked"'
...
function Log::logInfo::successLevel { #@test
  stub date \
    '* : echo "dateMocked"' \
    '* : echo "dateMocked"'
...
function Log::logInfo::warningLevel { #@test
  stub date \
    '* : echo "dateMocked"'
...
function Log::logInfo::errorLevel { #@test
  stub date \
    '* : echo "dateMocked"'
...
function Log::logInfo::offLevel { #@test
