...
setup() {
  ...
  mkdir -p "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn" "${BATS_TEST_TMPDIR}/conf/dsn2"
  cp "${BATS_TEST_DIRNAME}/testsData/dsn/"* "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn"
  cp "${BATS_TEST_DIRNAME}/testsData/dsn/default.local.env" "${BATS_TEST_TMPDIR}/conf/dsn2/myConf.sh"
...
function Conf::getAbsoluteFile::EnvFileFromHome { #@test
  ...
  assert_success
  assert_output "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn/default.local.env"
}
...
function Conf::getAbsoluteFile::ShFileFromHomeDefaultExtension { #@test
  ...
  assert_success
  assert_output "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn/otherInvalidExt2.sh"
}
...
function Conf::getAbsoluteFile::Relative { #@test
  mkdir -p "${BATS_TEST_TMPDIR}/home/.bash-tools/data"
  touch "${BATS_TEST_TMPDIR}/home/.bash-tools/data/dsn_valid.env"
...
function Conf::getAbsoluteFile::RootDir { #@test
  (
    ...
    assert_success
    assert_output "${BATS_TEST_TMPDIR}/conf/dsn2/myConf.sh"
  )
}
...
function Conf::getAbsoluteFile::AbsoluteFileIgnoresConfFolderAndExt { #@test
  ...
  run Conf::getAbsoluteFile "data" "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn/otherInvalidExt.ext" "sh"
  assert_success
  assert_output "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn/otherInvalidExt.ext"
}

function Conf::getAbsoluteFile::AbsoluteFileIgnoresConfFolderAndExt2 { #@test
  touch "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn/dsn_invalid_port.sh"

  run Conf::getAbsoluteFile "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn/dsn_invalid_port.sh" "data" "env"
  assert_success
  assert_output "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn/dsn_invalid_port.sh"
}

function Conf::getAbsoluteFile::FileWithoutExtension { #@test
  touch "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn/noExtension"

  run Conf::getAbsoluteFile "dsn" "noExtension" ""
  assert_success
  assert_output "${BATS_TEST_TMPDIR}/home/.bash-tools/dsn/noExtension"
}
