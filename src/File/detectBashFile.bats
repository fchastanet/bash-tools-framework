...
function File::detectBashFile::forgotToInit { #@test
  run File::detectBashFile "${srcDir}/File/detectBashFile.sh"
  assert_failure
  assert_output --partial "File::detectBashFile: missingBashFileList variable is not set, you should call File::detectBashFileInit before using File::detectBashFile"
}
