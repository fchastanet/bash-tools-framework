...
function Options::generateOptionCommonStringOrStringArray::authorizedValuesValueMissingValue { #@test
  run Options::generateOptionCommonStringOrStringArray "Options::generateOptionString" --authorized-values
  assert_success
  assert_lines_count 2
  assert_line --index 0 "export authorizedValues=''"
  assert_line --index 1 "export helpValueName='String'"
...
function Options::generateOptionCommonStringOrStringArray::authorizedValuesValueInvalidValue { #@test
  run Options::generateOptionCommonStringOrStringArray "Options::generateOptionString" --authorized-values " invalid | valid"
  assert_failure 1
...
function Options::generateOptionCommonStringOrStringArray::setAll { #@test
  run Options::generateOptionCommonStringOrStringArray "Options::generateOptionString" --authorized-values "valid|invalid" --help-value-name "name"
  assert_success
  assert_lines_count 2
...
function Options::generateOptionCommonStringOrStringArray::setInvalidOption { #@test
  run Options::generateOptionCommonStringOrStringArray "Options::generateOptionString" --authorized-values "valid|invalid" --other-param
  assert_success
  assert_line --index 0 "export authorizedValues='valid|invalid'"
  assert_line --index 1 "export helpValueName='String'"
}
