...
function Compiler::Implement::interfaceFunctions::Empty { #@test
  run Compiler::Implement::interfaceFunctions ""
  assert_failure 1
  assert_lines_count 1
  assert_output --partial "ERROR   - Interface '${interface}' is not a valid bash framework function name"
}

function Compiler::Implement::interfaceFunctions::InvalidBashFrameworkFunction { #@test
  run Compiler::Implement::interfaceFunctions "Implemented::data::François"
  assert_failure 1
  assert_lines_count 1
...
function Compiler::Implement::interfaceFunctions::BashFrameworkFunctionNotFound { #@test
  ...
  local status=0
  Compiler::Implement::interfaceFunctions "Compiler::Implement::interfaceFunctions" "${BATS_TEST_DIRNAME}" >"${BATS_TEST_TMPDIR}/result" 2>&1 || status=$?
  [[ "${status}" = "2" ]]
  run cat "${BATS_TEST_TMPDIR}/result"
  assert_lines_count 1
  assert_output --partial "ERROR   - Interface 'Compiler::Implement::interfaceFunctions' cannot be found in any src dirs: ${BATS_TEST_DIRNAME}"
}
...
function Compiler::Implement::interfaceFunctions::BashFrameworkFunctionErrorDuringCall { #@test
  ...
  local status=0
  Compiler::Implement::interfaceFunctions "Compiler::Implement::interfaceFunctions" >"${BATS_TEST_TMPDIR}/result" 2>&1 || status=$?
  [[ "${status}" = "3" ]]
  run cat "${BATS_TEST_TMPDIR}/result"
  assert_lines_count 2
  assert_line --index 0 --partial "ERROR   - Interface '' is not a valid bash framework function name"
  assert_line --index 1 --partial "ERROR   - Calling interface 'Compiler::Implement::interfaceFunctions' has generated an error"
}
...
function Compiler::Implement::interfaceFunctions::InterfaceEmptyList { #@test
  ...
  local status=0
  Compiler::Implement::interfaceFunctions "Namespace::interfaceEmptyList" >"${BATS_TEST_TMPDIR}/result" 2>&1 || status=$?
  [[ "${status}" = "4" ]]
  run cat "${BATS_TEST_TMPDIR}/result"
  assert_lines_count 1
...
function Compiler::Implement::interfaceFunctions::InterfaceInvalidList { #@test
  ...
  local status=0
  Compiler::Implement::interfaceFunctions "Namespace::interfaceInvalidList" >"${BATS_TEST_TMPDIR}/result" 2>&1 || status=$?
  [[ "${status}" = "5" ]]
  run cat "${BATS_TEST_TMPDIR}/result"
  assert_lines_count 1
...
function Compiler::Implement::interfaceFunctions::validInterface { #@test
  ...
  local status=0
  Compiler::Implement::interfaceFunctions "Namespace::interfaceValidList" >"${BATS_TEST_TMPDIR}/result" 2>&1 || status=$?
  [[ "${status}" = "0" ]]
  run cat "${BATS_TEST_TMPDIR}/result"
  assert_output "$(cat "${BATS_TEST_DIRNAME}/testsData/interfaceFunctions.validInterface.expected.txt")"
}
