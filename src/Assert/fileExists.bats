...
function Assert::fileExists::notRightUser { #@test
  ...
  assert_failure 1
  assert_lines_count 2
  assert_line --index 0 --partial "INFO    - Check ${BATS_RUN_TMPDIR}/myFile exists with user userUnknown:$(id -gn)"
  assert_line --index 1 --partial "ERROR   - incorrect user ownership on file ${BATS_RUN_TMPDIR}/myFile"
}
...
function Assert::fileExists::notRightGroup { #@test
  ...
  assert_failure 1
  assert_lines_count 2
  assert_line --index 0 --partial "INFO    - Check ${BATS_RUN_TMPDIR}/myFile exists with user $(id -un):groupUnknown"
  assert_line --index 1 --partial "ERROR   - incorrect group ownership on file ${BATS_RUN_TMPDIR}/myFile"
}
...
function Assert::fileExists::valid { #@test
  ...
  assert_line --index 0 --partial "INFO    - Check ${BATS_RUN_TMPDIR}/myFile exists with user $(id -un):$(id -gn)"
}
